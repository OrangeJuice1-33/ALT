...
"[project]/alt/src/app/top-rated/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TopRatedPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(53);
    if ($[0] !== "9a992e1bd55ec412ab5182aa4da4a3adcd08ac0054210a434c4a0e6b90a79d70") {
        for(let $i = 0; $i < 53; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "9a992e1bd55ec412ab5182aa4da4a3adcd08ac0054210a434c4a0e6b90a79d70";
    }
    ...
    let t1;
    if ($[2] !== amenities || $[3] !== bookingsMin || $[4] !== category || $[5] !== city || $[6] !== priceMax || $[7] !== region || $[8] !== stars || $[9] !== subtype) {
        t1 = __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$data$2f$sampleListings$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].filter({
            "TopRatedPage[sampleData.filter()]": (l)=>{
                ...
                if (city && l.city.toLowerCase() !== city.toLowerCase()) {
                    return false;
                }
                if (region && l.region !== region) {
                    return false;
                }
                if (stars && l.rating < stars) {
                    return false;
                }
                ...
                for (const a of amenities){
                    if (!l.amenities.includes(a)) {
                        return false;
                    }
                }
                return true;
            }
        }["TopRatedPage[sampleData.filter()]"]);
        $[2] = amenities;
        $[3] = bookingsMin;
        $[4] = category;
        $[5] = city;
    ...
    let t7;
    let t8;
    if ($[11] !== amenities || $[12] !== bookingsMin || $[13] !== category || $[14] !== city || $[15] !== endDateStr || $[16] !== filtered || $[17] !== priceMax || $[18] !== region || $[19] !== stars || $[20] !== startDateStr || $[21] !== subtype) {
        const sorted = [
            ...filtered
        ].sort(_TopRatedPageAnonymous);
        t8 = "min-h-screen bg-[radial-gradient(circle_at_top_left,#07102a_0%,#03031a_60%)] text-white p-6";
        t4 = "max-w-7xl mx-auto";
        if ($[29] === Symbol.for("react.memo_cache_sentinel")) {
            t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
        ...
        t3 = sorted.map(_TopRatedPageSortedMap);
        $[11] = amenities;
        $[12] = bookingsMin;
        $[13] = category;
        $[14] = city;
    ...
    let t10;
    if ($[44] !== t4 || $[45] !== t5 || $[46] !== t6 || $[47] !== t7 || $[48] !== t9) {
...
_s(TopRatedPage, "NIivAtrEnydMjgKbsDRtkgxrmWs=");
_c = TopRatedPage;
function _TopRatedPageSortedMap(item) {
...
function _TopRatedPageAnonymous(a_0, b) {
    return b.rating - a_0.rating;
}
var _c;
...
//# sourceMappingURL=alt_2650f40d._.js.map