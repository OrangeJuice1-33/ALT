...
"[project]/alt/src/app/add-venue/gallery/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VenueGalleryPage() {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(29);
    if ($[0] !== "8a63bfea0774765e60f9619625f384f5b00e5518bbfde71330d154125ec6d5ef") {
        for(let $i = 0; $i < 29; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "8a63bfea0774765e60f9619625f384f5b00e5518bbfde71330d154125ec6d5ef";
    }
    ...
    const [items, setItems] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t1);
    ...
    let t2;
    if ($[4] !== venueId) {
        t2 = async function uploadToStorage(file) {
            const filename = `${venueId}-${Date.now()}.${file.name.split(".").pop()}`;
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseBrowser"].storage.from("venue-gallery").upload(filename, file);
            if (error) {
                throw error;
            }
            const { data } = __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseBrowser"].storage.from("venue-gallery").getPublicUrl(filename);
    ...
    const uploadToStorage = t2;
    let t3;
    if ($[6] !== items) {
        t3 = async function addItem(e) {
            const file_0 = e.target.files?.[0];
            if (!file_0) {
                return;
            }
            const temp = URL.createObjectURL(file_0);
            setItems([
                ...items,
                {
                    tempUrl: temp,
    ...
    const addItem = t3;
    let t4;
    if ($[8] !== items || $[9] !== router || $[10] !== uploadToStorage || $[11] !== venueId) {
        t4 = async function submitGallery() {
            if (items.length < 5) {
            ...
            for (const it of items){
                ...
                const { error: error_0 } = await __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseBrowser"].from("venue_gallery").insert({
                    venue_id: venueId,
                    url: publicUrl,
                    caption: it.caption
                });
                if (error_0) {
                    alert("Upload failed: " + error_0.message);
                    setUploading(false);
                    return;
                }
            }
            await __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabaseBrowser"].from("venue_listings").update({
                step: 6
            }).eq("id", venueId);
            setUploading(false);
    ...
    if ($[13] === Symbol.for("react.memo_cache_sentinel")) {
        ...
        t6 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
    ...
    let t7;
    if ($[15] !== addItem) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
            type: "file",
            accept: "image/*",
            onChange: addItem,
            className: "mb-4"
    ...
    if ($[17] !== items) {
        t8 = items.map({
            "VenueGalleryPage[items.map()]": (it_0, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                            value: it_0.caption,
                            onChange: {
                                "VenueGalleryPage[items.map() > <input>.onChange]": (e_0)=>{
                                    const copy = [
                                        ...items
                                    ];
                                    copy[i].caption = e_0.target.value;
                                    setItems(copy);
                                }
                            }["VenueGalleryPage[items.map() > <input>.onChange]"],
                            placeholder: "Caption",
    ...
    const t10 = uploading ? "Submitting..." : "Next";
    let t11;
    if ($[21] !== submitGallery || $[22] !== t10 || $[23] !== uploading) {
        t11 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(VenueGalleryPage, "eUkyZwTDlzcCBcSnadS9hjv35jk=", false, function() {
    return [
...
_c = VenueGalleryPage;
var _c;
__turbopack_context__.k.register(_c, "VenueGalleryPage");
...
//# sourceMappingURL=alt_96dca17d._.js.map