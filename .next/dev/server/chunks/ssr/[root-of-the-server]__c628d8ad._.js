...
function AuthListener() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const { data: listener } = __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseBrowser"].auth.onAuthStateChange(async (event, session)=>{
            if (event === "SIGNED_IN") {
                ...
                if (!user) return;
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$alt$2f$src$2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabaseBrowser"].from("profiles").select("*").eq("id", user.id).maybeSingle();
                if (!profile) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c628d8ad._.js.map